...
def launch_setup(context: LaunchContext, *args, **kwargs):
    ...
    return [
        ...
        # Visual odometry
        # NOTE: if we use zed's odometry, we don't use rtabmap odometry.
        # however, the rtabmap system doesn't actually work without zed's odometry.
        Node(
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'use_zed_odometry', default_value='true', # default : false
